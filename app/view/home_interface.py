...
class HomeInterface(ScrollArea):
    ...
    def loadSamples(self):
        ...
        basicInputView.addSampleCard(
            ...
            title="ComboBox",
            content=self.tr("A drop-down list of items a user can select from."),
            routeKey="basicInputInterface",
            index=10,
        )
        basicInputView.addSampleCard(
            ...
            content=self.tr("A button that displays a flyout of choices when clicked."),
            routeKey="basicInputInterface",
            index=12,
        )
        basicInputView.addSampleCard(
        ...
        basicInputView.addSampleCard(
            ...
            title="SwitchButton",
            content=self.tr("A switch that can be toggled between 2 states."),
            routeKey="basicInputInterface",
            index=25,
        )
        basicInputView.addSampleCard(
        ...
        materialView.addSampleCard(
            ...
            title="AcrylicLabel",
            content=self.tr("A translucent material recommended for panel background."),
        ...
        menuView.addSampleCard(
            ...
            title="RoundMenu",
            content=self.tr("Shows a contextual list of simple commands or options."),
        ...
        stateInfoView.addSampleCard(
            ...
            title="ToolTip",
            content=self.tr("Displays information for an element in a pop-up window."),
            routeKey="statusInfoInterface",
            index=1,
        )
